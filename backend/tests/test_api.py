...
def test_create_employee_validation_errors(client):
    ...
    # Test empty name
    resp1 = client.post('/api/employees', json={
        "name": "", "email": "valid@example.com", "department": "Dev", "position": "Lead", "salary": 50000
    })
    ...
    resp2 = client.post('/api/employees', json={
        "name": "John", "email": "invalid-email", "department": "Dev", "position": "Lead", "salary": 50000
    })
    ...
    resp3 = client.post('/api/employees', json={
        "name": "John", "email": "john@example.com", "department": "Dev", "position": "Lead", "salary": -100
    })
